                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="fileinput-new" data-provides="fileinput" style="padding-top:0px !important; padding-left: 0px !important">
                      <input type="file" name="category_image" value="<?= $category_data->image; ?>" class="form-control mb-2" accept="image/x-png,image/jpeg" >
                      <div class="fileinput-preview text-left" data-trigger="fileinput" style="padding-left: 0px !important; padding-top:0px !important;"><img style="width:25%; border:1px solid #ccc; background: #f3f3f3; margin-bottom: 5px" src="<?php echo base_url('uploads/categories/'.$category_data->image);?>" /></div>
                  </div>
                </div>
