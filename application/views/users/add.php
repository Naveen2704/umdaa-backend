        ...
        <div class="card-body">
            <div class="container">
                <div class="row justify-content-around">
                    <div class="col-md-12">
                        <form method="post" action="<?=base_url("Users/AddUser")?>" autocomplete="off">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-4">
                                    <input type="text" name="mobile" onkeypress="return numeric()" maxlength="12" id="mobile" class="form-control" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-4 text-right">
                                        ...
                                        if(count($profiles) > 0){
                                            foreach($profiles as $value){
                                                if($value->profile_id==1)
                                                    continue;
                                                ?>
                                                <option value="<?=$value->profile_id?>"><?=ucwords($value->profile_name)?></option>
                                                <?php
                                            }
                                        }
                                        ?>
